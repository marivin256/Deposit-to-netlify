    ...
    return(
        <div className="">
            <div className="text-center py-4 px-10 ">
                ...
                <p className="">A standard of nowadays interfaces is to allow users to log <br/> in and sign up with Social
                    media accounts like <span className="text-purple-700">Google, <br /> Apple,etc.</span>
                </p>
            </div>

            <div id="box" className="py-11 px-8 max-w-sm  mx-auto bg-white rounded-xl shadow-lg space-y-2 sm:py-4  sm:items-center space-y-6 sm:space-x-6">
